...
⚡ WGAGN loss / Conditional WGAN loss 중 하나만 사용하고, 그 차이를 성능 평가 실시
...
> $\bar e$: normalized embedding

<br/>

⭐ <span style="background-color:#FFED81">**✔ Generator와 Discriminator의 최종 Loss**</span>
